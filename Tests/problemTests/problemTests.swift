...
final class problemTests: XCTestCase {
    ...
    func testProblem44() throws {
        XCTAssertEqual(problem44(), 5482660)
    }
    func testProblem45() throws {
        XCTAssertEqual(problem45(), 1533776805)
    }
    func testProblem46() throws {
        XCTAssertEqual(problem46(), 5777)
    }
    func testProblem47() throws {
        XCTAssertEqual(problem47(n: 2), 14)
    ...
    func testProblem49() throws {
        XCTAssertEqual(problem49(), "296962999629")
    }
    func testProblem50() throws {
        XCTAssertEqual(problem50(max: 100), 41)
        XCTAssertEqual(problem50(max: 1000), 953)
        XCTAssertEqual(problem50(max: 1000000), 997651)
    }
    func testProblem51() throws {
        XCTAssertEqual(problem51(expectedSize: 6, primedigits: 2), 13)
        XCTAssertEqual(problem51(expectedSize: 7, primedigits: 5), 56003)
        //XCTAssertEqual(problem51(expectedSize: 8, primedigits: 6), 121313)
    }
    func testProblem52() throws {
        XCTAssertEqual(problem52(to: 2), 125874)
        XCTAssertEqual(problem52(to: 6), 142857)
    }
    ...
    func testProblem69() throws {
        XCTAssertEqual(problem69(max: 10), 6)
        XCTAssertEqual(problem69(max: 1000000), 510510)
    }
    func testProblem79() throws {
        XCTAssertEqual(problem79(), 73162890)
    }
}
